...
public class MockiStore {
	...
	public String getAddress_ormat() {
		return address_ormat;
	}

	public void setAddress_ormat(String address_ormat) {
		this.address_ormat = address_ormat;
	}
